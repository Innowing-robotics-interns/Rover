...
: ${AMENT_CURRENT_PREFIX:="/mnt/nova_ssd/workspaces/pcl_ws/install/pcl_filter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pcl_filter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pcl_filter/environment/path.sh"
