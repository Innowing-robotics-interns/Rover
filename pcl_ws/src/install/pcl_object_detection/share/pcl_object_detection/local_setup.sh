...
: ${AMENT_CURRENT_PREFIX:="/mnt/nova_ssd/workspaces/pcl_ws/src/install/pcl_object_detection"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pcl_object_detection/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pcl_object_detection/environment/path.sh"
