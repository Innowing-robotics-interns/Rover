...
: ${AMENT_CURRENT_PREFIX:="/mnt/nova_ssd/workspaces/texttopoint_ws/install/point_publisher_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/point_publisher_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/point_publisher_pkg/environment/path.sh"
