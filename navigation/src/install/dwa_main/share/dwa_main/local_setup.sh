...
: ${AMENT_CURRENT_PREFIX:="/mnt/nova_ssd/workspaces/navigation/src/install/dwa_main"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dwa_main/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dwa_main/environment/path.sh"
